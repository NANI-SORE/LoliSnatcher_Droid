...
class CustomBetterPlayerMaterialControls extends StatefulWidget {
  const CustomBetterPlayerMaterialControls({
  ...
  State<StatefulWidget> createState() {
    return _CustomBetterPlayerMaterialControlsState();
  }
}

class _CustomBetterPlayerMaterialControlsState extends BetterPlayerControlsState<CustomBetterPlayerMaterialControls> {
  ...
  void didChangeDependencies() {
    ...
    _betterPlayerController = widget.playerController;
